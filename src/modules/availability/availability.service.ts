...
export class AvailabilityService {
  ...
  async getBlockedTimes(
    ...
    const queryBuilder = this.blockedTimeRepository
      ...
      .where('blockedTime.businessId = :businessId', {
        businessId: business.id,
      })
  ...
  async updateBlockedTime(
    ...
    const nextStart =
      dto.startDateTime ?? blockedTime.startDateTime.toISOString();
    ...
    if (dto.startDateTime !== undefined)
      blockedTime.startDateTime = new Date(dto.startDateTime);
    if (dto.endDateTime !== undefined)
      blockedTime.endDateTime = new Date(dto.endDateTime);
